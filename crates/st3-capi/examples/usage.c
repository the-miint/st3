 ...
 *
 * Build the shared library with `cargo build --release`, then, from the
 * repository root, compile against the committed header:
 *
 *   cc -std=c11 -I crates/st3-capi/include crates/st3-capi/examples/usage.c \
 *       -L target/release -lst3 -lm -o usage
 *   LD_LIBRARY_PATH=target/release ./usage
 *
 * (`crates/st3-capi/tests/c_example.rs` compiles and runs this file as part of
 * the test suite, against the header freshly generated by the build.)
 *
